...
class TreeNode(object):
    ...
    def select(self):
        ...
        """
        return max(iter(self._children.items()), key=lambda act_node: act_node[1].get_value())
...
class MCTS(object):
    ...
    def get_move(self, state):
        ...
        return max(iter(self._root._children.items()), key=lambda act_node: act_node[1]._n_visits)[0]
